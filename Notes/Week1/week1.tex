...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        % \begin{proof}
        %     Let $V$ be a finite-dimensional vector space. Let $I$ be the isomorphism defined above. To prove that $I$ is canonical, it will suffice to show that $I$ does not depend on the choice of some basis (for either $V$ or $(V^*)^*$). In other words, we want to show that for any basis of $V$ in which we describe an arbitrary $v\in V$, $I(v)$ refers to the same element of $(V^*)^*$.\par
        %     Let $\beta_1=\{e_1,\dots,e_n\}$ and $\beta_2=\{f_1,\dots,f_n\}$ be bases of $V$. Suppose
        %     \begin{align*}
        ...
        %     Then
        %     \begin{align*}
        %         [I(v)](\varphi) &= I_v(\varphi)\\
        %         &= \varphi(v)
        %     \end{align*}
        % \end{proof}
        % \item Let $e_1,\dots,e_n$ be a basis of $V$ and $f_1,\dots,f_n$ be a basis of $V^*$. Let $v=a_1e_1+\cdots+a_ne_n$ and $\varphi=b_1f_1+\cdots+b_nf_n$, where $a_1,\dots,a_n,b_1,\dots,b_n\in\R$. Then
        % \begin{align*}
        %     \varphi_v(\phi) &= b_1\varphi_v(f_1)+\cdots+b_n\varphi_v(f_n)\\
        %     &= b_1f_1(v)+\cdots+b_nf_n(v)\\
        %     &= b_1[a_1f_1(e_1)+\cdots+a_nf_1(e_n)]+\cdots+b_n[a_1f_n(e_1)+\cdots+a_nf_n(e_n)]\\
        %     &= \sum_{i,j=1}^nb_ia_jf_i(e_j)
        % \end{align*}
        % \begin{align*}
        %     \iota(v) = 
        % \end{align*}
